  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="px-4 py-12 md:py-20 max-w-6xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-900 font-bold max-w-3xl mx-auto mb-8">
      ...
      <div className="flex flex-col">
        ...
        <section className="relative">
          ...
          <div className="max-w-6xl mx-auto px-4 py-12 md:py-20">
            <div className="bg-white rounded-lg shadow-xl p-8 md:p-12 -mt-20 md:-mt-32 relative z-10">
              ...
              <div>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
                  <p className="text-yellow-800 font-semibold">
                    ⚡ Posti limitati: solo 12 partecipanti per gruppo per
